...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>AK INFO - Especialista em TI</title>
        ...
        <div class="navbar navbar-inverse navbar-static-top" role="navigation">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="http://www.akinfo.com.br"><img src="images/logo.png" style=" height: 25px;"></a>
            </div>
            <div class="navbar-collapse collapse" style="height: auto;">
              <ul class="nav navbar-nav">
                <li class="active"><a href="http://getbootstrap.com/examples/carousel/#">Home</a></li>
                <li><a href="http://getbootstrap.com/examples/carousel/#about">Sobre Nós</a></li>
                
                <li class="dropdown">
                  <a href="http://getbootstrap.com/examples/carousel/#" class="dropdown-toggle" data-toggle="dropdown">Serviços<b class="caret"></b></a>
                ...
                <li><a href="http://getbootstrap.com/examples/carousel/#contact">Contato</a></li>
              </ul>
            </div>
          </div>
        </div>
